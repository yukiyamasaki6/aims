  ...
  public: {
    Tables: {
      ...
      target_face_rings: {
        ...
        Relationships: [
          {
            foreignKeyName: "target_face_rings_spot_id_fkey";
            columns: ["spot_id"];
            isOneToOne: false;
            referencedRelation: "target_face_spots";
            referencedColumns: ["id"];
          },
        ];
      };
      target_face_spots: {
        ...
        Relationships: [
          {
            foreignKeyName: "target_face_spots_target_face_id_fkey";
            columns: ["target_face_id"];
            isOneToOne: false;
            referencedRelation: "target_faces";
            referencedColumns: ["id"];
      ...
      target_faces: {
        ...
        Relationships: [
          {
            foreignKeyName: "target_faces_owner_id_fkey";
            columns: ["owner_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
