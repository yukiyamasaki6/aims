...
describe("validateSignInFields", () => {
  ...
  describe("メールアドレス", () => {
    it("上限境界（253/254/255文字）で、255文字のみエラーになる", () => {
      ...
      // When
      const belowMaximumResult = validateSignInFields(
        belowMaximum,
        "password1",
      );
