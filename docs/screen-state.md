...
| 背景操作 | - |  | 無効 | ⚠ |
| 送信失敗[通信エラー] | - |  | 未登録（メッセージ表示） | ⚠ |
| 送信失敗[登録済みメールアドレス] | - |  | 未登録（メッセージ表示） | 〇 |
| 送信失敗[rate_limit] | - |  | 未登録（メッセージ表示） | △ |
| 送信失敗[captcha_failed] | - |  | 未登録（メッセージ表示） | △ |
| 送信失敗[未定義error.code] | - |  | 未登録（メッセージ表示） | △ |
| 送信成功 | - |  | コード入力へ | 〇 |
...
| 確認失敗[通信エラー] | - |  | 未確認（メッセージ表示） | ⚠ | - |  |
| 確認失敗[otp_expired] | - |  | 未確認（メッセージ表示） | 〇 | - |  |
| 確認失敗[未定義error.code] | - |  | 未確認（メッセージ表示） | △ | - |  |
| 確認成功 | - |  | パスワード設定へ | 〇 | - |  |
| 再送失敗[通信エラー] | - |  | - |  | 未確認（メッセージ表示） | ⚠ |
| 再送失敗[rate_limit] | - |  | - |  | 未確認（メッセージ表示） | △ |
| 再送失敗[captcha_failed] | - |  | - |  | 未確認（メッセージ表示） | △ |
| 再送失敗[未定義error.code] | - |  | - |  | 未確認（メッセージ表示） | △ |
| 再送成功 | - |  | - |  | 未確認（確認メッセージなし） | △ |
...
| 登録ボタン[適正] | 送信中 | 〇 | 無効 | ⚠ |
| 送信失敗[通信エラー] | - |  | 未送信（メッセージ表示） | ⚠ |
| 送信失敗[weak_password] | - |  | 未送信（メッセージ表示） | 〇 |
| 送信失敗[未定義error.code] | - |  | 未送信（メッセージ表示） | △ |
| 送信成功 | - |  | /roundsへ遷移 | 〇 |
